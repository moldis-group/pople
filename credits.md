...
[_Critical Benchmarking of the G4(MP2) Model, the Correlation Consistent Composite Approach and Popular Density Functional Approximations on a Probabilistically Pruned Benchmark Dataset of Formation Enthalpies](https://doi.org/10.1063/5.0032713), Sambit Kumar Das, Sabyasachi Chakraborty, Raghunathan Ramakrishnan, The Journal of Chemical Physics, 154 (2021) 044113.

### G4(MP2)-XP method

[_All hands on deck: Accelerating ab initio thermochemistry via wavefunction approximations](), Sambit Kumar Das, Salini Senthil, Sabyasachi Chakraborty, Raghunathan Ramakrishnan, submitted (2021).
